...
import { type StorageAdapter, STORAGE_KEYS, CURRENT_STORAGE_VERSION } from './types';
...
export class AsyncStorageAdapter implements StorageAdapter {
  ...
  async ensureMigrated(): Promise<void> {
    ...
    if (version < CURRENT_STORAGE_VERSION) {
      ...
      await AsyncStorage.setItem(STORAGE_KEYS.STORAGE_VERSION, String(CURRENT_STORAGE_VERSION));
    }
