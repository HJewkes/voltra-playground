    ...
    >
      {workout && (
        <ScrollView className="max-h-96" showsVerticalScrollIndicator={false}>
          <Text className="text-content-tertiary text-center mb-4">
              ...
              <Surface elevation="inset" radius="lg" border={false}>
                <View className="p-4">
                  {workout.reps.map((rep, index) => {
                    ...
                    const duration = metrics.eccentricDuration + metrics.concentricDuration + 
                      metrics.topPauseTime + metrics.bottomPauseTime;
                    ...
                    return (
                      ...
                      >
                        <View className="flex-row justify-between mb-1">
                          ...
                          <Text className="text-content-tertiary text-sm">{tempo}</Text>
                        </View>
