...
class BLERelay:
    ...
    def __init__(self) -> None:
        ...
        self._connected_device: dict[str, str] | None = None  # Track connected device info
    ...
    async def connect(self, device_id: str, device_name: str | None = None) -> None:
    ...
    def _on_disconnect(self, _client: BleakClient) -> None:
        ...
        print("[Relay] Device disconnected unexpectedly")
        self.client = None
...
async def websocket_endpoint(websocket: WebSocket) -> None:
    ...
    ble_status = (
        f"connected to {status['device']['name']}" if status["connected"] else "not connected"
    )
    print(f"[Relay] WebSocket connected, BLE {ble_status}")
